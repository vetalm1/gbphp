...
--
-- Хост: 127.0.0.1:3307
-- Время создания: Авг 27 2019 г., 14:52
...
INSERT INTO `basket` (`id_basket`, `user_name`, `id_good`, `good_name`, `price`) VALUES
(32, 'Vetal', 3, 'Cтул белый', 1200),
(35, 'Vetal', 1, 'Чаша-толкушка', 500),
(36, 'Vetal', 2, 'Светильник серый', 1000),
...
--
ALTER TABLE `basket`
  MODIFY `id_basket` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
