...
addToOrders($_GET['summ']);

if ($_GET['order_id']) {
    $employes2 = selectByOrder($_GET['order_id']);
} else {
...
<body>
    ...
    <br>
    <table class='card table ml-5' style="width: 37rem;">
    ...
    <a class="alert alert-warning" href="basket.php?summ=<?=$summ?>"> Заказать</a>
